  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-white border-b shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        {/* Logo */}
        <div className="text-2xl font-bold text-[#78350f]">Pure Farm Dung</div>

        {/* Desktop Menu */}
        <nav className="hidden md:flex space-x-8 text-sm font-medium text-gray-700">
          <a href="#home" className="hover:text-[#78350f]">Home</a>
        ...
        <a
          href="#contact"
          className="hidden md:inline-block bg-[#78350f] text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-[#92400e] transition"
        >
          Get Free Quote
        </a>
      ...
      {open && (
        <div className="md:hidden bg-white px-6 pb-4 space-y-2 shadow-sm">
          <a href="#home" className="block py-2 text-gray-700 hover:text-[#78350f]">Home</a>
